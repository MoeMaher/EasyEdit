...
from easyeditor import KNHyperParams, FTHyperParams, KETrainingHparams,\
    ...
    SERACTrainingHparams, SERACHparams, IKEHyperParams, FTApiHyperParams, LoRAHyperParams, MAHERHyperParams
...
def test_MAHER_llama2():
    ...
    hparams = MAHERHyperParams.from_hparams('./hparams/Maher/llama-7b')
    editor = BaseEditor.from_hparams(hparams)
    metrics, edited_model, _ = editor.edit(
        prompts=prompts,
        ground_truth=ground_truth,
